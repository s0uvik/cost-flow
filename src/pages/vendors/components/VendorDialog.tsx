...
export function VendorDialog({ open, editing, onClose }: Props) {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: { name: '', email: '', phone: '', address: '', category_id: null, notes: '' },
  })
  ...
  useEffect(() => {
    form.reset(editing
      ...
      : { name: '', email: '', phone: '', address: '', category_id: null, notes: '' }
    )
  }, [editing, open])
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <FormField control={form.control} name="email" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Input type="email" placeholder="vendor@email.com" {...field} value={field.value ?? ''} /></FormControl>
                  <FormMessage />
                </FormItem>
              )} />
