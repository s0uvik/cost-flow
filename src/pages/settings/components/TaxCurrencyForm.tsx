          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <FormField control={form.control} name="tax_name" render={({ field }) => (
                  <FormItem>
                    <FormLabel>Tax Label <span className="text-muted-foreground">(optional)</span></FormLabel>
                    <FormControl><Input placeholder="GST, VAT, etc." {...field} /></FormControl>
                    <FormDescription className="text-xs">Shown on invoices</FormDescription>
                    <FormMessage />
                  </FormItem>
                )} />
                ...
                <FormField control={form.control} name="tax_rate" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription className="text-xs">Default rate for new invoices</FormDescription>
                    <FormMessage />
                  </FormItem>
                )} />
              </div>
