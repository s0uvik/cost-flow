...
export function CategoryList({ categories, isLoading, type, onAdd, onEdit, onDelete }: Props) {
    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className={`size-2.5 rounded-full ${isIncome ? 'bg-green-500' : 'bg-red-500'}`} />
      ...
      {isLoading ? (
        ...
        <div className="rounded-lg border border-dashed p-8 text-center">
          <p className="text-sm text-muted-foreground mb-3">No {type} categories yet</p>
